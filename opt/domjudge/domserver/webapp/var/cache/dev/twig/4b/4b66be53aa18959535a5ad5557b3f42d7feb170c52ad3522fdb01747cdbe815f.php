...
class __TwigTemplate_0da5208178e697a9dcc4a9d143d973bd67251dd0a747dcf2c64dac1d09f64f2f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
(isset($context["allowed_authmethods"]) || array_key_exists("allowed_authmethods", $context) ? $context["allowed_authmethods"] : (function () { throw new RuntimeError('Variable "allowed_authmethods" does not exist.', 14, $this->source); })())) && (twig_length_filter($this->env, (isset($context["auth_ipaddress_users"]) || array_key_exists("auth_ipaddress_users", $context) ? $context["auth_ipaddress_users"] : (function () { throw new RuntimeError('Variable "auth_ipaddress_users" does not exist.', 14, $this->source); })())) > 0)));
    ...
    <div class=\"form-signin\" id=\"loginform\">
        ...
        // line 123
        echo twig_escape_filter($this->env, (isset($context["DOMJUDGE_VERSION"]) || array_key_exists("DOMJUDGE_VERSION", $context) ? $context["DOMJUDGE_VERSION"] : (function () { throw new RuntimeError('Variable "DOMJUDGE_VERSION" does not exist.', 123, $this->source); })()), "html", null, true);
        echo "</p>
...
{% endblock %}
", "security/login.html.twig", "/opt/domjudge/domserver/webapp/templates/security/login.html.twig");
    }
}
