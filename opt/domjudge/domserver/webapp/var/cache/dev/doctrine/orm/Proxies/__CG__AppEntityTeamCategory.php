...
class TeamCategory extends \App\Entity\TeamCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'categoryid', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'name', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'sortorder', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'color', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'visible', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'teams', '' . "\0" . 'App\\Entity\\TeamCategory' . "\0" . 'contests'];
        }
