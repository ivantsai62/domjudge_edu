...
return $this->privates['App\\Form\\Type\\TeamAffiliationType'] = new \App\Form\Type\TeamAffiliationType(($this->privates['App\\Service\\EventLogService'] ?? $this->getEventLogServiceService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
