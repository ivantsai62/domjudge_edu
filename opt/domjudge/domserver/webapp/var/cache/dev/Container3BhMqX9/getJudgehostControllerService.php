...
$instance->setContainer(($this->privates['.service_locator.uHzIXYg'] ?? $this->load('get_ServiceLocator_UHzIXYgService.php'))->withContext('App\\Controller\\API\\JudgehostController', $this));
