...
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-bundle/Security/FirewallContext.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/Util/TargetPathTrait.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/Firewall/ExceptionListener.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/EntryPoint/AuthenticationEntryPointInterface.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/EntryPoint/FormAuthenticationEntryPoint.php';
...
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/Firewall/LogoutListener.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/Logout/LogoutSuccessHandlerInterface.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/Logout/DefaultLogoutSuccessHandler.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/Logout/LogoutHandlerInterface.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/Logout/CsrfTokenClearingLogoutHandler.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-http/Logout/SessionLogoutHandler.php';
include_once $this->targetDirs[4].'/lib/vendor/symfony/security-bundle/Security/FirewallConfig.php';
