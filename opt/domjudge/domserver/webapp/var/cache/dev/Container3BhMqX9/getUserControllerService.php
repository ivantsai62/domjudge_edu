...
include_once $this->targetDirs[3].'/src/Controller/API/UserController.php';
...
$instance->setContainer(($this->privates['.service_locator.uHzIXYg'] ?? $this->load('get_ServiceLocator_UHzIXYgService.php'))->withContext('App\\Controller\\API\\UserController', $this));
