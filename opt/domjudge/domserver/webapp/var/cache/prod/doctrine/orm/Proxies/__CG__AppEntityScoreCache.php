...
class ScoreCache extends \App\Entity\ScoreCache implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getAllTaskPoint(): ?array
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAllTaskPoint', []);

        return parent::getAllTaskPoint();
    }

    /**
     * {@inheritDoc}
     */
    public function setAllTaskPoint(?array $all_task_point): \App\Entity\ScoreCache
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAllTaskPoint', [$all_task_point]);

        return parent::setAllTaskPoint($all_task_point);
    }
