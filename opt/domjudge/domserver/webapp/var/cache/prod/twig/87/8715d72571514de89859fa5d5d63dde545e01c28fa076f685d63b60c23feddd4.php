...
class __TwigTemplate_b3abef8af9961d6180a5a138411456262c2dacfd5930cc3b3202bf91edd95a29 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<script>
    ...
    \$(function () {
        ...
        if ((twig_length_filter($this->env, ($context["judgings"] ?? null)) > 1)) {
            ...
            // line 75
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_array_filter(($context["judgings"] ?? null), function ($__judging__) use ($context) { $context["judging"] = $__judging__; return twig_get_attribute($this->env, $this->source, $context["judging"], "result", [], "any", false, false, false, 75); }));
            foreach ($context['_seq'] as $context["_key"] => $context["judging"]) {
                // line 76
                echo "                    {
                        \"label\": \"j";
