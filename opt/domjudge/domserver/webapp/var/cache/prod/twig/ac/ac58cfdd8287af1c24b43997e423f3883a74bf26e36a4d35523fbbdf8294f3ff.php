...
class __TwigTemplate_de7e2b060c7878411926326967ce464a1470fe1bb6c121fd6e870cbf006f932d extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      ";
        ...
        values: [
          ...
          ";
            ...
            echo "          ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_array_filter(($context["submissions"] ?? null), function ($__submission__) use ($context) { $context["submission"] = $__submission__; return twig_get_attribute($this->env, $this->source, $context["submission"], "result", [], "any", false, false, false, 237); }));
