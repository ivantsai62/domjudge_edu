...
/* jury/user.html.twig */
class __TwigTemplate_891555f8b0605e5f632b551ff5fee05752222d6dda1351d008414f440edd0019 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "team", [], "any", false, false, false, 78)) {
            ...
            echo "\">
                                ";
            // line 81
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "team", [], "any", false, false, false, 81), "name", [], "any", false, false, false, 81), "html", null, true);
            echo " (t";
