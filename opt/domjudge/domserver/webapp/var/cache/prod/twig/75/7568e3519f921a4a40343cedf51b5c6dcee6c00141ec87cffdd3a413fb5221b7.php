...
class __TwigTemplate_5cd6e4d03381d70b2069608bad57758cdc354fef61a154c06b1830cc62fbefc3 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row equal mt-3\">
    <div class=\"col-12\">
      <h1>Team ";
        ...
        echo ": ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["team"] ?? null), "name", [], "any", false, false, false, 30), "html", null, true);
        echo "</h1>
    </div>
    ...
    ";
            ...
            echo " = [
        {
          ...
          values: [
            ...
            // line 106
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_array_filter(($context["judgings"] ?? null), function ($__j__) use ($context) { $context["j"] = $__j__; return (twig_get_attribute($this->env, $this->source, $context["j"], "result", [], "any", false, false, false, 106) && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["j"], "submission", [], "any", false, false, false, 106), "problem", [], "any", false, false, false, 106) == $context["problem"])); }));
      ...
      ";
        ...
        values: [
          ...
          ";
            ...
            echo "          ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_array_filter(($context["submissions"] ?? null), function ($__submission__) use ($context) { $context["submission"] = $__submission__; return twig_get_attribute($this->env, $this->source, $context["submission"], "result", [], "any", false, false, false, 239); }));
