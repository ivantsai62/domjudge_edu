...
class __TwigTemplate_f6855fa02a2f9aaf18664a47ae8591277256c8c51cc16deaa2f60490666508fc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["clarification"] ?? null), "category", [], "any", false, false, false, 8)) {
    ...
    <div class=\"card-body\">
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["clarification"] ?? null), "sender", [], "any", false, false, false, 22))) {
            // line 23
            echo "                        ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["clarification"] ?? null), "sender", [], "any", false, false, false, 23), "name", [], "any", false, false, false, 23), "html", null, true);
            echo " (t";
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["clarification"] ?? null), "recipient", [], "any", false, false, false, 29))) {
            // line 30
            echo "                        ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["clarification"] ?? null), "recipient", [], "any", false, false, false, 30), "name", [], "any", false, false, false, 30), "html", null, true);
            echo " (t";
