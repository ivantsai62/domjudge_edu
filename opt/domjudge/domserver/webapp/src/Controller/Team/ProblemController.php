...
class ProblemController extends BaseController
{
    ...
    //新增problemlist 將每個問題分別列出

     /**
     * @Route("/problem_list/{probId<\d+>}", name="problemlist")
     * @param Request           $request
     * @param SubmissionService $submissionService
     * @param int               $probId
     
     */
    public function problemlistAction(int $probId)
    {
        /** @var Problem $problem */
        ...
        return $this->render('team/problem_list.html.twig', $data);
    }
